...
print(sqrt(1121314151617181910))
#1058921220.685081
...
print(1389026623 - 1058921220)
# 330,105,403
# Half this as the number ends in zero so can't be from an odd number
...
print(check_square_form(1121314151617181910))
